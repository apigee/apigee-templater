...
<head>
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 42 42' fill='none'%3E%3Crect width='42' height='42' rx='10' fill='%23151d30'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M29.3 10H32.5V32H29.3V27.6A11 11 0 1 1 29.3 14.4V10ZM20.5 13.2A7.8 7.8 0 1 0 20.5 28.8A7.8 7.8 0 0 0 20.5 13.2Z' fill='%23ffffff'/%3E%3C/svg%3E" />
  ...
  <header class="mobile-header">
    <div class="brand">
      <svg class="brand-logo" width="36" height="36" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Aft Logo">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M29.3 10H32.5V32H29.3V27.6A11 11 0 1 1 29.3 14.4V10ZM20.5 13.2A7.8 7.8 0 1 0 20.5 28.8A7.8 7.8 0 0 0 20.5 13.2Z" fill="#ffffff" stroke="#ffffff" stroke-width="0.5" stroke-linejoin="round"/>
      </svg>
