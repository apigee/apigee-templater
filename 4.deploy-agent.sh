...
--set-env-vars="GOOGLE_CLOUD_PROJECT=$GOOGLE_CLOUD_PROJECT,GOOGLE_CLOUD_LOCATION=$GOOGLE_CLOUD_LOCATION,GOOGLE_GENAI_USE_VERTEXAI=TRUE,GOOGLE_CLIENT_ID=$GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET=$GOOGLE_CLIENT_SECRET,APIGEE_TEMPLATER_MCP_URL=$APIGEE_TEMPLATER_MCP_URL,APIGEE_USER_MCP_URL=$APIGEE_USER_MCP_URL"
cd ..
